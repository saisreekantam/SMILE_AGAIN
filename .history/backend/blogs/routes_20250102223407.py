...
def register_routes(app):
    app.register_blueprint(bl, url_prefix='/main')

    # Create a new community
    @bl.route('/communities/create', methods=['POST'])
    @login_required
    ...
    @bl.route('/communities/<int:community_id>/join', methods=['POST'])
    @login_required
    ...
    @bl.route('/communities', methods=['GET'])
    @login_required
    ...
    # Create a new blog
    @bl.route('/blogs/create', methods=['POST'])
    @login_required
    def create_blog():
        data = request.json
    ...
    @bl.route('/blogs/<int:blog_id>/comments', methods=['POST'])
    @login_required
    ...
    @bl.route('/blogs/<int:blog_id>/comments', methods=['GET'])
    @login_required
    ...
    @bl.route('/online-users', methods=['GET'])
    @login_required
    def online_users():
