...
def register_routes(app):
    ...
    @.route('/communities/create', methods=['POST'])
    @login_required
    ...
    @.route('/communities/<int:community_id>/join', methods=['POST'])
    @login_required
    ...
    @.route('/blogs/<int:blog_id>/comments', methods=['POST'])
    @login_required
    ...
    @.route('/blogs/<int:blog_id>/comments', methods=['GET'])
    @login_required
