...
def register_routes(app):
    app.register_blueprint(blogs_bp, url_prefix='/b')

    # Create a new community
    @blogs_bp.route('/communities/create', methods=['POST'])
    @login_required
    ...
    @blogs_bp.route('/communities/<int:community_id>/join', methods=['POST'])
    @login_required
