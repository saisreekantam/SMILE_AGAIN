...
class GroupMembers(db.Model):
    ...
    joined_at = db.Column(db.DateTime, default=datetime.utcnow, nullable=False)  # Timestamp for when the user joined
    role = db.Column(db.String(50), nullable=True)  # Optional field for role in the group (e.g., "admin", "member")
